    ...
    @component('components.dashboard-layout', [
        ...
        <div class="flex flex-col gap-9">
            <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                ...
                <form enctype="multipart/form-data" method="post" action="{{ !empty($edit) && $edit->id ? route("admin.products.update", ["id" => $edit->id]) : route("admin.products.store") }}" class="flex flex-col gap-5.5 p-6.5">
                    ...
                    <div>
                        ...
                        <input value="{{ !empty($edit) && $edit->price ? $edit->price : @old("price") }}"  type="text" name="price" class="w-full rounded-lg border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary">
                    </div>
                    <div>
                        <label class="mb-3 block text-sm font-medium text-black dark:text-white">
                            دسته‌بندی محصول 
                        ...
                        >
                            ...
                            <option @if(!empty($edit) && $edit->product_category_id == $product_category->id) selected @endif value="{{  $product_category->id }}">{{  $product_category->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div>
                        ...
                        <div class="flex gap-5 items-center justify-between">
                            ...
                            @if (!empty($edit->image))
                                <div class="relative">
                                    ...
                                    <a href="{{ route("admin.products.remove.image", ["id" => $edit->id ]) }}">
