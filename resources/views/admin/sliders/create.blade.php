...
@section('content')
    @component('components.dashboard-layout', [
        'title' => __('pages.sliders'),
    ])
        <div class="flex flex-col gap-9">
            <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
               
                <form enctype="multipart/form-data" method="post" action="{{ !empty($edit) && $edit->id ? route("admin.sliders.update", ["id" => $edit->id]) : route("admin.sliders.store") }}" class="flex flex-col gap-5.5 p-6.5">
                        ...
                        <div class="flex gap-5 items-center justify-between">
                            ...
                            @if (!empty($edit->image))
                                <div class="relative">
                                    ...
                                    <a href="{{ route("admin.sliders.remove.image", ["id" => $edit->id ]) }}">
