...
@section('content')
    ...
    @component('components.dashboard-layout', [
        ...
        'link' => route('admin.product_categories.create'),
    ])
        <div
                                ...
                                <tr>
                                    ...
                                    <td class="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                        @include('partials.operation', [
                                            'removeLink' => route('admin.product_categories.remove', ['id' => $row->id]),
                                            'editLink' => route('admin.product_categories.show', ['id' => $row->id]),
                                        ])
                                    </td>
                                </tr>
                            @endforeach
