    ...
    @component('components.dashboard-layout', [
        ...
        <div class="flex flex-col gap-9">
            <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                ...
                <form enctype="multipart/form-data" method="post" action="{{ !empty($edit) && $edit->id ? route("admin.courses.update", ["id" => $edit->id]) : route("admin.courses.store") }}" class="flex flex-col gap-5.5 p-6.5">
                    ...
                    <div>
                        ...
                        >
                            ...
                            <option @if(!empty($edit) && $edit->course_category_id == $category->id) selected @endif value="{{  $category->id }}">{{  $category->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div>
