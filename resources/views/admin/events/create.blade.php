        ...
        <div class="flex flex-col gap-9">
            <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                ...
                <form enctype="multipart/form-data" method="post"
                    action="{{ !empty($edit) && $edit->id ? route('admin.events.update', ['id' => $edit->id]) : route('admin.events.store') }}"
                    ...
                    <div>
                        ...
                        <input value="{{ !empty($edit) && $edit->expired_at ? $edit->expired_at_fa : @old('expired_at') }}"
                            type="text" name="expired_at"
                    ...
                    <div>
                        ...
                        <select name="event_category_id"
                            ...
                            @foreach ($event_categories as $event_category)
                                <option @if (!empty($edit) && $edit->event_category_id == $event_category->id) selected @endif value="{{ $event_category->id }}">
